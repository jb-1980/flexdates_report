    ...
    //$(".flexdates-report-progress-cell").hover(function (url,id){
    //        $("#tmp").html($('.flexdates-report-progress-circle').html());
    //        var title = $(this).children().html();
    //        $('.flexdates-report-progress-circle').html(title);
    //    }, function(){
    //        var content = $("#tmp").html();
    //        $('.flexdates-report-progress-circle').html(content);
    //    }
    //);
//    /* ===========================================================
...
//    }( window.jQuery );
    ...
    $(".flexdates-report-progress-cell").popover({
        trigger:"hover",
        placement:"right",
        html:true
    });
    ...
    //            type:"POST",
    //            dataType:"html",
    //            url:'/moodle/blocks/flexdates_report/ajax/addtask.php?instance='+instance+'&modid='+module,
    //            data:data,
